...
export function HeroSection() {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-2">
      ...
      <div className="absolute bottom-1/4 right-1/4 w-64 h-64 bg-primary/5 rounded-full blur-3xl animate-pulse z-[1]" style={{ animationDelay: "1s" }} />
      ...
      <div className="container mx-auto px-6 relative z-10 mb-40">
        <div className="max-w-5xl mx-auto text-center font-bold">
          ...
          >
            ...
            <RotatingText 
              words={["empresas", "negócios", "resultados", "inovação", "mudanças"]} 
            />
          </motion.h1>
          ...
          >
            Ajudamos empresas a utilizar a tecnologia do jeito certo para acelerar mudanças, 
            reduzir custos e tornar o dia a dia mais eficiente.
          </motion.p>
