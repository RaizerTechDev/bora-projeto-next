  ...
  return (
    <section id="servicos" className="py-24 relative">
      <div className="container mx-auto px-6">
        ...
        >
          <span className="text-primary text-sm font-medium uppercase tracking-wider">O que fazemos</span>
          ...
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
            ...
            Ser uma organização AI First não é mais uma escolha - é uma necessidade.
          </p>
        </motion.div>
