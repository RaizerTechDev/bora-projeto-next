...
const services = [
  {
    ...
    title: "Consultoria",
    description:
      "Diagnóstico estratégico e visão de futuro para guiar sua empresa nas decisões mais importantes.",
  },
  {
    icon: Users,
    title: "Assessoria",
  ...
  },
  {
    ...
    title: "Capacitação",
    description:
      "Treinamentos sob medida para preparar sua equipe para os desafios da tecnologia.",
  },
  {
    icon: Code2,
    title: "Soluções Digitais",
    description:
      "Soluções sob demanda - da ideia ao código - com agilidade e escalabilidade.",
  },
];
 ...
 group-hover:scale-110
      ...
      group-hover:text-white"
                  ...
                  <div className="mt-4 flex items-center text-cyan-300 opacity-0 group-hover:opacity-100 transition-all duration-300 translate-x-[-10px] group-hover:translate-x-0">
                    <Link
                      href="https://api.whatsapp.com/send?phone=5192364249&text=Olá!%20Quero%20entender%20como%20esse%20serviço%20pode%20ajudar%20meu%20negócio."
                      target="_blank"
