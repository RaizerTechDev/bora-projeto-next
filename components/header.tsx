...
export function Header() {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50  <header bg-gradient-to-r from-[#131727]/80 via-[#28355A]/70 to-[#131727]/80 
      ...
      <div className="container mx-auto px-6">
        <div className="flex items-center justify-between h-16 lg:h-20">
          ...
          {/* Desktop Navigation */}
            ...
            <Link href="/solucoes" className="hover:text-cyan-400 transition-colors">Soluções</Link>
            <Link href="/ia" className="hover:text-cyan-400 transition-colors">Fábrica de IAs</Link>
            <Link href="/encontro" className="hover:text-cyan-400 transition-colors">Encontros</Link>
          </nav>  
